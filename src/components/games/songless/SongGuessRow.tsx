...
interface SongGuessRowProps {
  guess: { title: string; artist: string } | "skipped";
  index: number;
  isCorrect: boolean;
}
...
export default function SongGuessRow({ guess, index, isCorrect }: SongGuessRowProps) {
    ...
    >
      ...
      {isSkipped ? (
        ...
        <p className="flex-1 min-w-0 truncate">
          ...
          <span className="text-muted text-xs"> — {guess.artist}</span>
        </p>
      )}
