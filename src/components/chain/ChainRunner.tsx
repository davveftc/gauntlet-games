...
import type { GameId, GameResult, ChainGameId } from "@/types";

/* ------------------------------------------------------------------ */
/*  Dynamically import each game page component (excluding wordless)   */
/* ------------------------------------------------------------------ */
const GameComponents: Record<ChainGameId, React.ComponentType> = {
...
export default function ChainRunner({
  ...
  return (
    <div>
      ...
      <ChainProvider chainId={chainId} linkIndex={linkIndex} onComplete={handleComplete}>
        <GameComponent />
      </ChainProvider>
      ...
      <Modal
        ...
        title="Leave The Chain?"
      >
        <p className="text-muted mb-6">
          If you leave now, the chain will break and all participants will lose their points.
        </p>
